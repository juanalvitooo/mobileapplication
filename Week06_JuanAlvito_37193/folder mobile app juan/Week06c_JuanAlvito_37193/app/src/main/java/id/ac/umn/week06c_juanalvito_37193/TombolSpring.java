package id.ac.umn.week06c_juanalvito_37193;
...
public class TombolSpring extends AppCompatButton {
    ...
    public boolean onTouchEvent(MotionEvent event){
        switch(event.getActionMasked()){
            case MotionEvent.ACTION_DOWN: final SpringAnimation anim = new SpringAnimation(this, (FloatPropertyCompat) DynamicAnimation.Y, this.getY());
